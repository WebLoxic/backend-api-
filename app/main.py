...
# =====================================================
# LIVE CANDLE WS ROUTES (IMPORTANT)
# =====================================================
from app.api.live_candle_ws_routes import router as live_candle_ws_router
app.include_router(live_candle_ws_router)
...
# =====================================================
# MARKET WS GLOBAL OBJECTS
# =====================================================
market_ws: Optional[MarketWebSocket] = None
subscription_manager: Optional[SubscriptionManager] = None
market_broadcaster = MarketBroadcaster()

# 🔥 REDIS CLIENT (FIXED ROOT CAUSE)
...
async def startup_core():
    ...
    log.info("🟢 QuantX Backend Core + Zerodha Market WS Started")
